...
import { type Product, type ProductFilters } from '@/store/productStore';
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleFiltersChange({ ...filters, minPrice: e.target.value ? parseFloat(e.target.value) : undefined })}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleFiltersChange({ ...filters, maxPrice: e.target.value ? parseFloat(e.target.value) : undefined })}
                  />
                </div>
              </div>
              <div className="mt-4 flex items-center space-x-4">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleFiltersChange({ ...filters, inStock: e.target.checked || undefined })}
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleFiltersChange({ ...filters, lowStock: e.target.checked || undefined })}
                  />
