...
import { type Order, type OrderFilters, type OrderStatus } from '@/store/orderStore';
            ...
            {orders.map((order) => {
              ...
              return (
                <tr key={order.id} className={isSelected ? 'bg-blue-50' : 'hover:bg-gray-50'}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap"></td>             <div className="text-sm font-medium text-gray-900 font-mono">
                      {order.orderNumber}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
